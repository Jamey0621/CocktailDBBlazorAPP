...
{
    public class DrinkModelData
    
    //Root myDeserializedClass = JsonConvert.DeserializeObject<Root>(myJsonResponse); public class Drink
    {
    ...
    public class Root
    {
        public List<DrinkModelData> drinks { get; set; }
    }
